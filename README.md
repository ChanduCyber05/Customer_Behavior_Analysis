...
Analyze customer behavior and patterns using SQL

Identify key metrics and trends affecting customer decisions
...
Identified trends in purchases and engagement
...
Visualized customer trends, KPIs, and segmentation
...
Analyzed purchasing patterns across different customer groups

Discovered trends in customer engagement and behavior
...
📦 Customer-Behavior-Analysis
 ...
 ┣ 📂 notebooks
 ┃ ┗ Customer_Behav_Data_Cleaning.ipynb
 ┣ 📂 sql
 ┃ ┗ Customer_Behavior_SQL_Query_Analysis.sql
 ┣ 📂 powerbi
 ┃ ┗ Customer_Behav_DB.pbix
 ┣ 📂 images
